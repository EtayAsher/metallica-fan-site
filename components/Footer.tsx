...
export default function Footer() {
  return (
    <footer className="border-t-4 border-yellow-500 bg-[#111111] mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            <h4 className="text-yellow-500 text-[10px] font-bold tracking-[0.4em] uppercase mb-4">Explore</h4>
            <ul className="space-y-2.5">
              {[{ href: "/albums", label: "Albums" }, { href: "/songs", label: "Songs" }, { href: "/members", label: "Members" }].map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-neutral-400 hover:text-yellow-400 text-xs tracking-[0.1em] uppercase transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-yellow-500 text-[10px] font-bold tracking-[0.4em] uppercase mb-4">Discover</h4>
            <ul className="space-y-2.5">
          ...
          <div>
            <h4 className="text-yellow-500 text-[10px] font-bold tracking-[0.4em] uppercase mb-4">Official</h4>
            <ul className="space-y-2.5">
              <li><span className="text-neutral-500 text-xs tracking-wider">metallica.com</span></li>
              <li><span className="text-neutral-500 text-xs tracking-wider">Blackened Recordings</span></li>
            </ul>
          </div>
        </div>
